...
This module provides a simplified linear weight system where:
- Questions answered correctly reset to 0.0
- All other questions in the same category increment by 0.1
- New questions start at 5.0
"""

# Configuration constants (must match app.py)
RECENT_ATTEMPTS_WINDOW = 5  # Only consider the last N attempts for mastery determination
